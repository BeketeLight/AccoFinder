        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                TextArea {
                    id: notesField
                    Layout.fillWidth: true
                    Layout.preferredHeight: Math.max(notesField.contentHeight + 36, 96)
                    placeholderText: ""
                    color: root.textColor
                    font.pixelSize: 12
                    ...
                    leftPadding: 14
                    rightPadding: 14
                    topPadding: notesField.activeFocus || notesField.text.length > 0 ? 30 : 12
                    bottomPadding: 8
                    ...
                    background: Item {
                        ...
                        Text {
                            id: notesFloating
                            readonly property bool isFloating: notesField.activeFocus || notesField.text.length > 0
                            text: qsTr("Add internal notes about this application...")
                            color: notesField.activeFocus ? root.primaryColor : root.mutedColor
                ...
                Label {
                    ...
                    text: qsTr("%L1 / %L2 characters").arg(notesField.length).arg(2000)
                    color: notesField.length >= 2000 ? root.dangerColor : root.mutedColor
                    font.pixelSize: 10
                }
